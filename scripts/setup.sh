...
setup_haskell() {
  ...
  local STACK_LIST="ghc-mod hlint stylish-haskell hasktags pointful hoogle apply-refact"

  # Comment out until fixed for ghc8
  #hscope pointfree machines-directory-0.2.0.9 machines-io-0.2.0.13 codex-0.5.0.2
